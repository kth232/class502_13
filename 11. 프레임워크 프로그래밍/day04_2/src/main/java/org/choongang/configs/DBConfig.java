...
//        ds.setUrl("jdbc:oracle:thin:@koreait.xyz:1521:XE");
...
//        ds.setPassword("_aA123456");
        ...
        ds.setTimeBetweenEvictionRunsMillis(1000 * 3); // 3초에 한번식 테스트
        ds.setMinEvictableIdleTimeMillis(1000 * 30); // 30초가 되면 유휴객체 새로 생성
